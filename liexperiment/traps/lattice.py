...
class lattice_modulation_depth(object):
    ...
    @property
    def depth_NE(self):
        return self.power_NE * self.cal.modulation_depth_per_watt_NE
     
    @property
    def depth_NW(self):
        return self.power_NW * self.cal.modulation_depth_per_watt_NW
     
    @property
    def depth_Ve(self):
        return self.power_Ve * self.cal.modulation_depth_per_watt_Ve
...
class TestHarmonicFermi(unittest.TestCase):
    def test_mu(self):
        ...
        power_NW = 0.5
        power_Ve = 0.7
        lat = lattice_modulation_depth(power_NE, power_NW, power_Ve)
        print "NE depth = {} Er".format(lat.depth_NE/lat.cal.recoil_rad_NE) 
